  ...
  return (
    ...
    >
        ...
        <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
          ...
          <div ref={mobileMenuRef} className="nav-hamburger-wrap">
            <button
    ...
    {/* Full-screen mobile menu — portaled to <body> so it escapes the nav's
        backdrop-filter, which would otherwise clip this fixed overlay to the
        nav's own 60px containing block instead of the full viewport. */}
